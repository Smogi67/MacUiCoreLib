...
local function loadDIIcons()
	...
	-- Map DI type keys to actual GitHub filenames (with spaces and capitals)
	local ICON_MAP = {
	...
	local GITHUB_BASE = "https://raw.githubusercontent.com/Smogi67/MacUiCoreLib/refs/heads/main/Icons"
	
	-- Create directory if it doesn't exist
	pcall(function()
		local testPath = ICON_DIR .. "/.test"
		writefile(testPath, "")
		delfile(testPath)
	end)
	...
	for key, fileName in pairs(ICON_MAP) do
		...
		local cached = pcall(function() return getcustomasset(localPath) end)
		if cached then
			DI_TYPE_ICON[key] = getcustomasset(localPath)
		else
			-- Download from GitHub and cache locally
		...
		if i.UserInputType==Enum.UserInputType.MouseButton1 or i.UserInputType==Enum.UserInputType.Touch then
			...
			if callback then
				...
				if not diNotifyCalled and DI_SHOWING and diCurrentType ~= "slider" then
					...
					diIcon.Image  = DI_TYPE_ICON["slider"] or DI_TYPE_ICON.custom
