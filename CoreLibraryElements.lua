...
-- These are uploaded to Roblox; tinted at runtime via diIcon.ImageColor3.
local DI_TYPE_ICON = {
	toggle   = "rbxassetid://77147650313828",   -- "Toggle on"
	slider   = "rbxassetid://128992990077777",  -- "Slider"
	dropdown = "rbxassetid://134561886899156",  -- "Dropdown selected"
	button   = "rbxassetid://74207222079588",   -- "Toggle off" (used for buttons)
	custom   = "rbxassetid://135869481800283",  -- "Custom circle"
	error    = "rbxassetid://83658533353029",   -- "Error"
	warning  = "rbxassetid://125297788832890",  -- "Warning"
}
local DI_TYPE_COLOR = {
